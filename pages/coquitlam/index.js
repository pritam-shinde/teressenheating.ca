              ...
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={3}>
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                      <Typography className='para'>When it comes to furnace installation, heating and maintenance, we have always been one of the leading brands to help you with quality AC installation services in Coquitlam. We make sure that everything is done at a relative pace with affordable pricing. We also make sure that you don&apos;t have to worry about anything. We take the charge of making sure that your tune-ups are done regularly in Coquitlam and nearby areas. You can easily book us online or can call us for quick assistance. Our executives will make sure to solve all your queries and provide reliable and trustworthy services.</Typography>
                      <Box mt={3}>
