...
const Rinnai = () => {
  ...
  const arrayFaq = [
    { id: "faq-1", que: "Do you install Rinnai tankless water heaters and heating systems in Burnaby?", ans: "Yes, we install Rinnai tankless water heaters, boilers, and direct-vent wall furnaces for homes and businesses throughout Burnaby.", list: null },
    { id: "faq-2", que: "Why is flushing important for Rinnai tankless water heaters?", ans: "Flushing removes scale and mineral deposits that build up inside the system over time. Regular descaling ensures proper heat transfer, prevents error codes, and extends unit life.", list: null },
    { id: "faq-3", que: "Can you repair Rinnai heating equipment?", ans: "Yes, our technicians diagnose and repair Rinnai tankless systems, boilers, and heating units to ensure your hot water and space heating remain reliable.", list: null },
    { id: "faq-4", que: "Is a Rinnai tankless water heater energy-efficient?", ans: "Rinnai tankless water heaters heat water on demand, eliminating the standby energy losses of traditional tank heaters and lowering gas usage.", list: null },
    { id: "faq-5", que: "Why choose Airlinx for Rinnai services in Burnaby?", ans: "Our trained technicians deliver expert Rinnai installation, maintenance, and repair services with clear communication, upfront pricing, and prompt local support.", list: null },
  ]
