                ...
                <Box py={3}>
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                      ...
                      <Typography className='para'>We get appreciated for our <a href="/boilers-installation/">heating installation services</a> in White-rock for the amount of work we do for all clients. No matter what, we always consider our clients as our kings. Hence, we provide quality <a href="/heating-services/">heating services</a> in White rock that makes you worry less and smile more. Also, we make sure that our <a href="/boilers-service/">installation, repair, and maintenance services</a> should suit your budget too. So, once you give us a call, we make sure that your work is done very easily. We would also like you to rate our services so that there is always a scope for improvement for us.</Typography>
                      <Box mt={3}>
