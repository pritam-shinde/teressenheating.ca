...
const Ameristar = () => {
  ...
  const arrayFaq = [
    { id: "faq-1", que: "Do you install Ameristar HVAC systems in Burnaby?", ans: "Yes, we install Ameristar furnaces, heat pumps, and air conditioners for residential and commercial properties in Burnaby, providing reliable heating and cooling at competitive prices.", list: null },
    { id: "faq-2", que: "What should I do if my Ameristar heat pump stops heating?", ans: "If your heat pump isn't heating properly, check your thermostat settings first. If the issue persists, our technicians can inspect the refrigerant levels, electrical connections, and system components to restore operation.", list: null },
    { id: "faq-3", que: "Can you perform routine maintenance on Ameristar equipment?", ans: "Yes. Regular maintenance keeps Ameristar heating and cooling systems running efficiently, extends equipment life, and prevents unexpected breakdowns.", list: null },
    { id: "faq-4", que: "Are Ameristar HVAC systems a good choice for budget-conscious homeowners?", ans: "Ameristar offers dependable performance and modern efficiency at an accessible price point, making it a great option for many Burnaby property owners.", list: null },
    { id: "faq-5", que: "Why choose Airlinx for Ameristar services in Burnaby?", ans: "Our team brings years of HVAC experience, providing expert Ameristar installation, repair, and maintenance with transparent pricing and exceptional customer care.", list: null },
  ]
