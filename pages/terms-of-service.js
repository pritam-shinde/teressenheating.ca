                        ...
                        <Grid container>
                            <Grid item xs={12} md={10} className="mx-auto">
                                <Box py={5}>
                                    ...
                                    <Typography className='para'>Airlinx Heating Ltd. in the case of owner bringing action against Airlinx Heating Ltd. shall be entitled to recover their lost time from other work, the cost of having technicians available either for depositions or testimony at trial, or for any other matter, caused by owner, and any other out-of-pocket costs that Airlinx Heating Ltd. may suffer by action of the owner.</Typography>

                                    <Typography className='para'>Owner shall not be entitled to any damages from Airlinx Heating Ltd., should they seek damages for any reason, other than those specifically referring to repairing or replacing the heating, cooling, or HVAC fixtures or piping or wiring damaged by the work described on reverse page. Under no circumstances will owner be entitled to any type of consequential or incidental damages such as lost wages, attorney’s fees, expert opinion fees, etc.</Typography>
                                    ...
                                    <Box mt={3}>
                                        ...
                                        <Typography className="para">In the event Client unsuccessfully brings action against Airlinx Heating Ltd., Airlinx Heating Ltd. shall be entitled to recover from Client its lost time from other work, the cost of having technicians available either for depositions or testimony at trial, or for any other matter, caused by Client, and any other out-of-pocket costs that Airlinx Heating Ltd. may suffer by action of Client.</Typography>

                                        <Typography className='para'>Under no circumstances shall Client be entitled to collect any type of consequential or incidental damages from Airlinx Heating Ltd., including, but not limited to, emotional distress, property damage, loss of use, lost wages, attorneys’ fees, expert opinion fees, etc.</Typography>
