...
import BoilerInstallationBanner from '../../public/boilerInstallation/boilerInstallation.jpg'
import Installation from '../../public/boilerInstallation/image.png'
...
const BoilerInstallation = () => {
  ...
  return (
    <>
    <Head>
      <title>Boiler Installation - teressenheating.ca</title>
      <meta name="description" content="" />
      <meta name="robots" content="index" />
      <link rel="canonical" href="/boilers-installation/" />
    </Head>
    <CommonBanner bg={BoilerInstallationBanner} title="Teressen boiler installation services" color="#fff" variant="h2" />
    <main>
                      ...
                      <Box mt={3}>
                        <Grid container spacing={3}>
                          <Grid item xs={12} md={6}>
                            <Box>
                              <Image src={Installation} alt="Boiler Installation" title='Boiler Installation' />
                            </Box>
                          </Grid>
                          <Grid item xs={12} md={6}>
                            <Box>
