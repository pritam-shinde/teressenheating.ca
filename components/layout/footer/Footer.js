                            ...
                            <Box py={5}>
                                <Grid container spacing={width < 992 ? 2 : 4}>
                                        ...
                                        <Box>
                                            ...
                                            <Box>
                                                <Typography className="text-white" align="justify">
                                                    Three elements that make Airlinx heating ltd different from the
                                                    crowd are Quality, trust, and affordability. These elements have
                                                    always been our brand identity and have made has to stand different
                                                    from the crowd. They have shaped us, monitored us, and made us the
                                                    best heating and air conditioning service in Canada .
                                                </Typography>
                                            </Box>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={4} lg={4}>
                                        <Box>
                                            <Box
                                                mb={width < 992 ? 2 : width < 1300 ? 3 : 3.2}
                                                pt={width < 992 ? 1 : width < 1403 ? 1 : 4}
                                            >
                                            ...
                                            <Grid container>
                                                <Grid item xs={6} md={6} lg={6}>
                                                    <ul>
                                                        <li>
                                                            <Link passHref prefetch={false} legacyBehavior href="/">
                                                ...
                                                <Grid item xs={6} md={6} lg={6}>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <Link passHref prefetch={false} legacyBehavior href="/faq/">
                                                ...
                                                <List className="p-0">
                                                    ...
                                                    <ListItem className="p-0">
                                                        <ListItemText
                                                            primary={
                                                                <p>
                                                                    <strong className="text--blue">Call :</strong>{" "}
                                                                    <a href="tel:604-363-6622" className="text-white">
                                                                        604-363-6622
                                                                    </a>
                                                                </p>
                                                            }
                                                    ...
                                                    <ListItem className="p-0">
                                                        <ListItemText
                                                            primary={
                                                                <p>
                                                                    <strong className="text--blue">Email :</strong>{" "}
                                                                    <a
                                                                        href="mailto:info@airlinxheating.ca"
                                                                        className="text-white"
                                                                    >
                                                                        info@airlinxheating.ca
                                                                    </a>
                                                                </p>
                                                            }
                                                        />
                    ...
                    <Box mb={2} style={{ borderBottom: "1px solid #fff", borderTop: "1px solid #fff" }}>
                        ...
                        <List className="d-flex flex-wrap justify-content-center">
                            {[
                                ...
                                <ListItem key={item.id} className="p-1 m-1" style={{ width: "fit-content" }}>
                            ...
                            <Grid item xs={12} md={12}>
                                <Box>
                                    <Grid container>
                                        <Grid item xs={12} md={10} className="mx-auto">
                                            <box
                                                className={`${width > 320 ? "d-flex" : "flex-column"} justify-content-center`}
                                            >
                                                <Box px={1}>
