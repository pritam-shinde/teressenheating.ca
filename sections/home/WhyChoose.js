                                ...
                                <Grid container>
                                    <Grid item xs={12} lg={4} className="ms-md-auto">
                                        <Box>
                                            ...
                                            <Typography className='para'>Our people are passionate about taking good care of your needs in the fastest possible ways out. Our customer service representatives, installers, and service technicians stay ahead of updates in the ever-changing HVAC field. Airlinx air conditioning and heating services come with no headache and no obligation consultation to determine the perfect system for your business and home.</Typography>
                                            <Box mt={3}>
