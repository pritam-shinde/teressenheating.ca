                        ...
                        <Grid item xs={12} sm={10} md={8} lg={6} className="mx-auto">
                            <Box py={5}>
                                ...
                                <Box mt={3}>
                                    ...
                                    <Typography align='center' className='para'>Airlinx service experts have extensive knowledge to get all the <Link href="/ac-repair/">repairs</Link> done right the first time. So, you can simply sit and relax and know more about <Link href="/furnace/">furnace repairs</Link> which assure 100% customer satisfaction.</Typography>
