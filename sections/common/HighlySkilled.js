                    ...
                    <Grid container>
                        <Grid item xs={12} sm={10} md={8} lg={6} className="mx-auto">
                            <Box py={5}>
                                ...
                                <Box mt={3}>
                                    <Typography align='center' className='para'>If your heating system is not working, then we are here to figure out what is wrong. Our experts have finished extensive testing to earn HVAC's gold standard certification. It means that we can manage any <Link href="/heating-services/">heating</Link> repair. </Typography>
                                    <Typography align='center' className='para'>Teressen service experts have extensive knowledge to get all the <Link href="/ac-repair/">repairs</Link> done right the first time. So, you can simply sit and relax and know more about <Link href="/furnace-inspection/">furnace repairs</Link> which assure 100% customer satisfaction.</Typography>
                                    <Typography align='center' className='para'>It might happen that a majority of furnace meltdowns can be stopped through our right service. This also keeps your warranty intact and helps your furnace run more efficiently. During furnace maintenance, our technicians will examine, clean, and lubricate all the essential components which are required during furnace maintenance. It involves a heat exchanger, which can give off deadly carbon monoxide if cracks are not noticed. Hence, Teressen offers a wide range of <Link href="/commercial-hvac/">HVAC services</Link> that will make it simple to keep up with maintenance.</Typography>
