                                    ...
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} md={4}>
                                            <Box className="d-flex flex-column align-items-center">
                                                ...
                                                <Box>
                                                    <Typography align='center'><strong style={{ fontSize: "1.5rem" }} ><Link legacyBehavior={true} href="/ac-installation/"><a className='text-white'>Installation</a></Link></strong></Typography>
                                                </Box>
                                            </Box>
                                        </Grid>
                                        <Grid item xs={12} md={4}>
                                            <Box className="d-flex flex-column align-items-center">
                                                ...
                                                <Box>
                                                    <Typography align='center'><strong style={{ fontSize: "1.5rem" }} ><Link legacyBehavior={true} href="/ac-repair/"><a className='text-white'>Repair</a></Link></strong></Typography>
                                                </Box>
                                            </Box>
                                        </Grid>
                                        <Grid item xs={12} md={4}>
